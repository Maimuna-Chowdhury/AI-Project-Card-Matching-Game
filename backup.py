...
def AI_cards(hand, current_deck, dealer_hand, reveal_dealer):
    ...
    # If the AI's score is 17 or higher, the AI should stand
    if value >= 17:
    ...
    # Heuristic approach to decide whether to hit or stand
    if value < 12:
        # Always hit if the AI's score is less than 12
        ...
        if dealer_value >= 7 and value < 17:
            ...
            # Stand if AI's score is 17 or higher
            return hand, current_deck
...
def AI_cards_fuzzy(hand, current_deck, dealer_hand, reveal_dealer):
    ...
    try:
        ...
        #print(f"AI Decision Value: {decision_value}")
...
def check_endgame(AI_S,hand_act, deal_score, play_score, result, totals, add,sc_board):
    ...
    # result 1- player bust, 2-win, 3-loss, 4-tie, 5-ai win
    ...
    if Mem.player_turn:
        ...
        if Mem.click_player_count == 1:
            ...
            if Mem.new_card.cget('text') == Mem.first_card.cget('text'):
                ...
                Mem.ai_memory.append(Mem.first_card)
                Mem.ai_memory.append(Mem.new_card)
